...
export const metadata: Metadata = {
  title: 'プライバシーポリシー | NaraiGo',
  description: 'NaraiGoのプライバシーポリシーです。個人情報の取扱い、Cookie、広告プログラムについてご確認ください。',
};
    ...
    <main className="legal-page">
      <article className="legal-content">
        ...
        <section className="legal-section">
          ...
          <p>当サイト「NaraiGo」（以下「当サイト」）では、お問い合わせの際に、お名前・メールアドレス等の個人情報をご提供いただく場合がございます。取得した個人情報は、お問い合わせへの回答や必要な情報をご連絡するためのみに利用し、これらの目的以外では利用いたしません。</p>
        </section>
