...
export default function DiagnosisPage() {
    ...
    const handleShare = useCallback(
        (platform: 'x' | 'line' | 'copy') => {
            ...
            const shareText = `うちの子にピッタリの習い事は「${topResult.service.name}」（おすすめ度${topResult.matchRate}%）でした！\n\n無料習い事診断はこちら\n${SITE_CONFIG.url}/diagnosis`;
            if (platform === 'x') {
        ...
        <>
            ...
            <section className="results-section">
                <div className="results-header">
                    <h2>お子さまにおすすめの習い事 TOP3</h2>
                    <p className="results-subtitle">回答を分析し、お子さまに最適な習い事を選びました</p>
                    <div style={{
                        ...
                        🌟 習い事を始めたお子さまの<span style={{ fontSize: '1.2em', textDecoration: 'underline' }}>94%</span>が
                        「自信がついた」と回答
                    </div>
                </div>
